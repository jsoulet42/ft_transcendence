...
class userAdmin(admin.ModelAdmin):
    list_display = ("username", "uuid", "list", "date_joined",
                    "nickname", "photo_medium_url", "photo_small_url")
...
class StatsAdmin(admin.ModelAdmin):
    list_display = ("user", "games_played",
                    "tournaments_played", "wins", "losses")
    search_fields = ("user",)


@admin.register(Game)
class GameAdmin(admin.ModelAdmin):
    list_display = ("host", "game_duration", "player1", "player2",
                    "player1_score", "player2_score", "tournament")
