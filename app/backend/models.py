...
class CustomUser(AbstractUser):
    ...
    list = models.ForeignKey('UsersList', null=False,
    ...
    tournaments = models.ManyToManyField(
        'Tournament', related_name='players', blank=True)
    stats = models.OneToOneField(
        'Stats', null=False, on_delete=models.CASCADE, related_name='user')
...
class Game(models.Model):
    ...
    tournament = models.ForeignKey(
        "Tournament", null=True, on_delete=models.CASCADE, related_name="tournament")
...
class Leaderboard(models.Model):
    ...
    """
    host = models.ForeignKey(
        "CustomUser", on_delete=models.CASCADE, related_name="leaderboard_host")
...
class Tournament(models.Model):
    ...
    players_count = models.PositiveSmallIntegerField(
        choices=COUNT_CHOICES, default=CHOICE_OPTION1)
    leaderboard = models.ForeignKey(
        "Leaderboard", null=True, on_delete=models.CASCADE, related_name="leaderboard")
